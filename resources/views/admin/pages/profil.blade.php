    ...
    <div class="white-box">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane  active" id="settings">
          ...
          {!! Form::model($user, [ 'method' => 'PUT', 'url' => ['profil/update', $user->id], 'class' => 'form-horizontal form-material','files' => true ]) !!}
              ...
              <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                  ...
                  <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
                    {!! Form::label('email', 'Email', ["for"=>"email" , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::text('email', null, ["id"=>"email", "type"=>"email", "name"=>"email", "class"=>"form-control form-control-line"]) !!} {!! $errors->first('email', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>

                  <div class="form-group {{ $errors->has('firstname') ? 'has-error' : ''}}">
                    {!! Form::label('firstname', 'First Name', ["for"=>"firstname" , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::text('firstname', null, ["id"=>"firstname", "type"=>"firstname", "name"=>"firstname", "class"=>"form-control form-control-line"]) !!} {!! $errors->first('firstname', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>

                  <div class="form-group {{ $errors->has('lastname') ? 'has-error' : ''}}">
                    {!! Form::label('lastname', 'Last Name', ["for"=>"lastname" , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::text('lastname', null, ["id"=>"lastname", "type"=>"lastname", "name"=>"lastname", "class"=>"form-control form-control-line"]) !!} {!! $errors->first('lastname', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 m-b-20">
                    ...
                    <div><img src="{{$user->avatar != null ? asset('uploads/avatars/'. $user->avatar) : asset('placeholder.png') }}" alt="user-img" class="img-circle fit"></div>
                  </div>
              ...
              <div class="panel-wrapper collapse" aria-expanded="true">
                <div class="panel-body">
                  ...
                  <div class="form-group {{ $errors->has('oldpassword') ? 'has-error' : ''}}">
                    {!! Form::label('oldpassword', 'Old password', ["for"=>'oldpassword' , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::password('oldpassword', ["id"=>'oldpassword', "type"=>'oldpassword', "name"=>'oldpassword', "class"=>"form-control form-control-line"]) !!} {!! $errors->first('oldpassword', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>

                  <div class="form-group {{ $errors->has('password') ? 'has-error' : ''}}">
                    {!! Form::label('password', 'New Password', ["for"=>'password' , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::password('password', ["id"=>'password', "type"=>'password', "name"=>'password', "class"=>"form-control form-control-line"]) !!} {!! $errors->first('password', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>

                  <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : ''}}">
                    {!! Form::label('password_confirmation', 'Confirm new password', ["for"=>'password_confirmation' , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::password('password_confirmation', ["id"=>'password_confirmation', "type"=>'password_confirmation', "name"=>'password_confirmation', "class"=>"form-control form-control-line"]) !!} {!! $errors->first('password_confirmation',
                      '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>
          ...
          <div class="col-lg-12 col-sm-12 col-md-12">
            <div class="panel panel-inverse">
              ...
              <div class="panel-wrapper collapse" aria-expanded="true">
                <div class="panel-body">
                  <div class="form-group ">
                    <label class="col-sm-12">Country</label> {!! Form::select('country', $countries,$user->country,["class"=>"form-control form-control-line", "id"=> "country" , "onChange"=> "getState(this.value);" ]); !!}
                  </div>
                  <div class="form-group ">
                    <label class="col-sm-12">state</label> {!! Form::select('state', array($user->state) ,null,["class"=>"form-control form-control-line", "id"=> "state" ,"onChange"=> "getCity(this.value);" ]);
                    !!}
                  </div>
                  <div class="form-group ">
                    <label class="col-sm-12">city</label> {!! Form::select('city', array($user->city) ,null,["class"=>"form-control form-control-line", "id"=> "city" ]); !!}
                  </div>

                  @if ($user->type == 'business')

                  <div class="form-group ">
                    <label class="col-sm-12">Business type</label> {!! Form::select('btype', ['1' => '1', '2' => '2'], $user->btype,["class"=>"form-control form-control-line", "id"=> "btype" ]); !!}
                  </div>
                  <div class="form-group {{ $errors->has('bname') ? 'has-error' : ''}}">
                    {!! Form::label('bname', 'Business name', ["for"=>"bname" , "class"=>"col-md-12"]) !!}
                    <div class="col-sm-6">
                      {!! Form::text('bname', null, ["id"=>"bname", "type"=>"bname", "name"=>"bname", "class"=>"form-control form-control-line"]) !!} {!! $errors->first('bname', '
                      <p class="help-block">:message</p>') !!}
                    </div>
                  </div>
                  @endif
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-wrapper collapse" aria-expanded="true">
                <div class="panel-body">
                  ...
                  {!! Form::label('phone_number', 'Phone Number', ["for"=>"phone_number" , "class"=>"col-md-12"]) !!}
                  <div class="col-sm-6">
                    {!! Form::text('phone_number', null, ["id"=>"phone_number", "type"=>"tel", "name"=>"phone_number", "class"=>"form-control form-control-line"]) !!} {!! $errors->first('phone_number', '
                    <p class="help-block">:message</p>') !!}
...
@section('js')
<script src="{{asset('js/intlTelInput.js')}}"></script>utils
<script src="{{asset('js/utils.js')}}"></script>
@include('landing.js') @endsection