@extends('landing.layout.homelayout') @section('header') @include('landing.sections.header') @endsection @section('form')
<style>
    .wrapper {
        width: 900px;
        max-width: 100%;
...
<form id="userreg" class="form-material" data-toggle="validator" method="POST" action="{{url('/register')}}">
 {!! csrf_field() !!}
            ...
            {!!  Form::select('country', $countries,null,["class"=>"form-control form-control-line", "id"=> "country" , "onChange"=> "getState(this.value);" ,"data-error"=>"You have to choose one" ,"required"]);   !!}
            </div>
            <div class="form-group ">
               <label class="col-sm-12">state</label>
            {!!  Form::select('state', array() ,null,["class"=>"form-control form-control-line", "id"=> "state" ,"onChange"=> "getCity(this.value);" ,"data-error"=>"You have to choose one" ,"required"]);   !!}
            </div>
            <div class="form-group ">
               <label class="col-sm-12">city</label>
            {!!  Form::select('city', array() ,null,["class"=>"form-control form-control-line", "id"=> "city"  ,"data-error"=>"You have to choose one" ,"required"]);   !!}
            </div>
                 ...
                 {!! Form::text('phone_number', null, ["id"=>"phone_number", "type"=>"tel", "name"=>"phone", "class"=>"form-control form-control-line", "data-error"=>"Unvalid First name" , "required"]) !!}
