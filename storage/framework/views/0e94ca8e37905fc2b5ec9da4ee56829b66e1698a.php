...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header ">
      ...
      <ul class="margleft">
      <a class="navbar-brand navbar-left " href="<?php echo e(url('/')); ?>">LOGO HERE</a>
      </ul>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right margright" id="removemargin">
        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo e(url('pregister')); ?>">Personal account</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?php echo e(url('bregister')); ?>">Business account</a></li>
          </ul>
        </li>
		<?php else: ?>
		<li><a id="drp"  href="<?php echo e(url('dashboard')); ?>" class="btn btn-default button" >Dashboard</a></li>
		<?php endif; ?>
