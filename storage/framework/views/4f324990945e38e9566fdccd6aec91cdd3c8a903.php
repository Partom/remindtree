...
<div class="row">
  <div class="col-md-12 col-xs-12">
    ...
    <h1>team <span id="grp-title-name"><?php echo e($team->name); ?></span>
         <?php if(Auth::user()->id == $team->owner_id): ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            <tbody>
                <tr>
                    <th>ID</th><td><?php echo e($team->id); ?></td>
                </tr>
                <tr><th> team Name </th><td id="grp-name" > <?php echo e($team->name); ?> </td></tr>
                 <tr><th> Members Count </th><td> <?php echo e($team->users->count()); ?> </td></tr>
            </tbody>
        </table>
    </div>
...
<?php echo Form::hidden('team_id', $team->id , ['class' => 'form-control','name' => 'team_id','id' => 'team_id' ]); ?>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><span class="label label-danger"><?php echo e($user->type); ?></span> </td>
                                        <?php echo Form::open(['url' => 'teams/removeuser', 'class' => 'form-horizontal', 'Method' => 'POST']); ?>
