        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 no-padding">
                <div class="left-content-content">
                    ...
                    <a class="read-more" href="style-one-image.html#">Read more</a>
                </div>
            </div>
            <!-- /End Column -->
            ...
            <div class="col-lg-6 col-md-6 no-padding">
                <div class="left-content-image">
                   <?php echo $__env->make('landing.sections.parts.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
            <!-- /End Column -->
        </div>
